    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">{{ $hotel->name }} </h4>
                    <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-tabs-success top-icon">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#price"><i class="zmdi zmdi-money"></i> <span class="hidden-xs">Price</span></a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    ...
                                    <div id="price" class="container tab-pane fade">
                                        @include('backend.hotel.includes.price')
                                    </div>
                                </div>
                            </div>
                        </div>
